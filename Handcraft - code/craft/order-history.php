...
?>
				<tr>
					...
					<td>
 <a href="javascript:void(0);" onClick="popUpWindow('http://localhost/Handcraft%20-%20code/Handcraft%20-%20code/craft/track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Track order">
					Track</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
