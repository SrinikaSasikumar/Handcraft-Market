...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/female-master-making-sculpture-from-clay_114579-11642.avif);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/dream-catcher-with-feathers-threads-beads-rope-hanging-dreamcatcher-handmade_84176-1592.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/woman-is-working-beaded-necklace-that-has-design-it_1285256-2065.jpg);">
			</div><!-- /.item -->
		</div>
		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/cropped-hands-woman-touching-beaded-fabric_1048944-18177397.jpg);">
			</div><!-- /.item -->
		</div>
	</div><!-- /.owl-carousel -->
</div>
